                ...
                case "touchstart":
                    switch (keyAction) {
                        ...
                        case "left-btn":
                            ...
                            this.nodesWrite.left.push(new Date() - this.model.startTime - 3080);
                            break;
                        case 39:
                        case 70:
                        case "right-btn":
                            ...
                            this.nodesWrite.right.push(new Date() - this.model.startTime - 3080);
                            break;
                        case 38:
                        case 83:
                        case "up-btn":
                            ...
                            this.nodesWrite.up.push(new Date() - this.model.startTime - 3080);
                            break;
                        case 40:
                        case 68:
                        case "down-btn":
